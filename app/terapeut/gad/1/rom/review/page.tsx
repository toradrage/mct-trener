      ...
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
        ...
        <div className="w-full mb-6">
          ...
          <ul className="list-disc ml-6 text-gray-700">
            {interventions.length > 0 ? (
              interventions.map((intv, i) => <li key={i}>{intv.type}</li>)
            ) : (
              <li>Ingen teknikker brukt</li>
            )}
          </ul>
        </div>
        ...
        <div className="w-full mb-6">
          ...
          <p className="text-gray-700">
            Bra jobbet! Du har gjennomført en økt og brukt {interventions.length} teknikk(er).
            Reflekter gjerne over hva som gikk bra og hva du kan gjøre annerledes neste gang.
          </p>
        </div>
